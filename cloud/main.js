...
Parse.Cloud.define('getSceneFromId', async (request) => {
...
Parse.Cloud.define('deleteSceneFromId', async (request) => {
  ...
  try {
      ...
      await scene.destroy().then((scene) => {
...
Parse.Cloud.define('getScenesOfUser', async (request) => {
...
Parse.Cloud.define('saveScene', async (request) => {
...
Parse.Cloud.afterSave(Scene, async (req, res) => {
